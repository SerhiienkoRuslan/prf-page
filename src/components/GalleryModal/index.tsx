...
const GalleryModal = ({ name, modalUrl, setModalUrl, gallery }: GalleryModalProps) => {
      ...
      <div ref={modalRef} className={styles.content}>
        ...
        <div className={styles.containerImage}>
          <div className={addTheme(styles.header)}>
            ...
            <button onClick={() => setModalUrl('')} className={addTheme(styles.closeButton)} data-atr='closeButton'>
              X
            </button>
          </div>
